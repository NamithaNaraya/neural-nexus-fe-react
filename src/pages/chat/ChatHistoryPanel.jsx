...
export const ChatHistoryPanel = React.memo(function ChatHistoryPanel({ chatHistory, onRestore, onDelete, onClose, activeSessionId, isLoading }) {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-[26px] border border-border/50 bg-card/92 shadow-[0_24px_70px_-50px_hsl(var(--primary)/0.24)] backdrop-blur-xl">
